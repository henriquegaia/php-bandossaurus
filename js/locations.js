//source::https://www.sitepoint.com/community/t/country-state-city-dropdown-list/2438
//test: http://localhost/_projetos/Others/make-a-band/backup/cities/cities.php
//////////////////////////////////////////////////////////////////////////////
// city_state.js ///////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
var all_regions = ['Africa', 'Asia','Oceania', 'Caribbean', 'Central America', 'Europe', 'Middle East', 'North America', 'South America'];

var countries = Object();

countries['Africa'] = '|Algeria|Angola|Benin|Botswana|Burkina Faso|Burundi|Cameroon|Cape Verde|Central African Republic|Chad|Congo, Dem.|Congo, Rep.|Djibouti|Egypt|Equatorial Guinea|Eritrea|Ethiopia|Gabon|Gambia|Ghana|Guinea|Guinea-Bissau|Kenya|Lesotho|Liberia|Libya|Madagascar|Malawi|Mali|Mauritania|Mauritius|Morocco|Mozambique|Namibia|Niger|Nigeria|Rwanda|Sao Tome/Principe|Senegal|Seychelles|Sierra Leone|Somalia|South Africa|Sudan|Swaziland|Tanzania|Togo|Tunisia|Uganda|Zambia|Zimbabwe';
countries['Asia'] = '|Bangladesh|Bhutan|Brunei|Myanmar|Cambodia|China|East Timor|India|Indonesia|Japan|Kazakhstan|North Korea|South Korea|Laos|Malaysia|Maldives|Mongolia|Nepal|Philippines|Russian Federation|Singapore|Sri Lanka|Taiwan|Thailand|Vietnam';
countries['Oceania'] = '|Australia|Fiji|Kiribati|Micronesia|Nauru|New Zealand|Palau|Papua New Guinea|Samoa|Tonga|Tuvalu|Vanuatu';
countries['Caribbean'] = '|Anguilla|Antigua/Barbuda|Aruba|Bahamas|Barbados|Cuba|Dominica|Dominican Republic|Grenada|Guadeloupe|Haiti|Jamaica|Martinique|Montserrat|Netherlands Antilles|Puerto Rico|St. Barts|St. Kitts/Nevis|St. Lucia|St. Martin/Sint Maarten|St Vincent/Grenadines|San Andres|Trinidad/Tobago|Turks/Caicos';
countries['Central America'] = '|Belize|Costa Rica|El Salvador|Guatemala|Honduras|Nicaragua|Panama';
countries['Europe'] = '|Albania|Andorra|Austria|Belarus|Belgium|Bosnia-Herzegovina|Bulgaria|Croatia|Czech Republic|Denmark|England|Estonia|Finland|France|Georgia|Germany|Greece|Hungary|Iceland|Ireland|Italy|Kosovo|Latvia|Liechtenstein|Lithuania|Luxembourg|Macedonia|Malta|Moldova|Monaco|Montenegro|Netherlands|Northern Ireland|Norway|Poland|Portugal|Romania|San Marino|Scotland|Serbia|Slovakia|Slovenia|Spain|Sweden|Switzerland|Ukraine|Vatican City|Wales';
...
city_states['Myanmar'] = '|Rangoon||Ayeyarwady|Bago|Chin|Kachin|Kayin|Kayah|Magway|Mandalay|Mon|Rakhine|Sagaing|Shan|Tanintharyi|Yangon';
...
city_states['North Korea'] = '|P\'yongyang||Chagang-do|Hamgyong-bukto|Hamgyong-namdo|Hwanghae-bukto|Hwanghae-namdo|Kaesong-si|Kangwon-do|Najin Sonbong-si|Namp\'o-si|P\'yongan-bukto|P\'yongan-namdo|P\'yongyang-si|Yanggang-do';
city_states['South Korea'] = '|Seoul||Cheju-do|Cholla-bukto|Cholla-namdo|Ch\'ungch\'ong-bukto|Ch\'ungch\'ong-namdo|Inch\'on-gwangyoksi|Kangwon-do|Kwangju-gwangyoksi|Kyonggi-do|Kyongsang-bukto|Kyongsang-namdo|Pusan-gwangyoksi|Soul-t\'ukpyolsi|Taegu-gwangyoksi|Taejon-gwangyoksi|Ulsan-gwangyoksi';
...
city_states['Singapore'] = 'Singapore';
...
city_states['St. Martin/Sint Maarten'] = 'St. Martin/Sint Maarten';
...
//Europe
city_states['Albania'] = '|Tirana||Berat|Bulqize|Delvine|Devoll|Diber|Durres|Elbasan|Fier|Gjirokaster|Gramsh|Has|Kavaje|Kolonje|Korce|Kruje|Kucove|Kukes|Kurbin|Lezhe|Librazhd|Lushnje|Malesi e Madhe|Mallakaster|Mat|Mirdite|Peqin|Permet|Pogradec|Puke|Sarande|Shkoder|Skrapar|Tepelene|Tropoje|Vlore';
...
city_states['Kosovo']='|Pristina||Prizren|Ferizaj|Pec|Gjakova|Gjilan|Mitrovica';
...
city_states['Montenegro'] = '|Podgorica||Bar|Berane|Bijelo Polje|Budva|Cetinje|Danilovgrad|Dobrota|Herceg-Novi|Igalo|Kolasin|Kotor|Mojkovac|Niksic|Plav|Pljevlja|Rozaje|Susanj|Tivat|Tuzi|Ulcinj';
...
city_states['Northern Ireland'] = '|Belfast||Antrim|County Antrim|Ards|Armagh|County Armagh|Ballymena|Ballymoney|Banbridge|Carrickfergus|Castlereagh|Coleraine|Cookstown|Craigavon|Down|County Down|Dungannon|Fermanagh|County Fermanagh|Larne|Limavady|Lisburn|County Londonderry|Derry|Magherafelt|Moyle|Newry/Mourne|Newtownabbey|North Down|Omagh|Strabane|County Tyrone';
...
city_states['Serbia'] = '|Belgrade||Cacak|Kragujevac|Kraljevo|Leskovac|Nis|Novi Sad|Novi Pazar|Pancevo|Smederevo|Subotica|Zemun|Zrenjanin';



city_states['Scotland'] = '|Edinburgh||Aberdeen City|Aberdeenshire|Angus|Argyll/Bute|The Scottish Borders|Clackmannanshire|Dumfries/Galloway|Dundee City|East Ayrshire|East Dunbartonshire|East Lothian|East Renfrewshire|Falkirk|Fife|Glasgow City|Highland|Inverclyde|Midlothian|Moray|North Ayrshire|North Lanarkshire|Orkney Islands|Perth/Kinross|Renfrewshire|Shetland Islands|South Ayrshire|South Lanarkshire|Stirling|West Dunbartonshire|Eilean Siar (Western Isles)|West Lothian';
...
city_states['Wales'] = '|Cardiff||Isle of Anglesey|Blaenau Gwent|Bridgend|Caerphilly|Ceredigion|Carmarthenshire|Conwy|Denbighshire|Flintshire|Gwynedd|Merthyr Tydfil|Monmouthshire|Neath Port Talbot|Newport|Pembrokeshire|Powys|Rhondda Cynon Taff|Swansea|Torfaen|The Vale of Glamorgan|Wrexham';
...
city_states['Azerbaijan'] = '|Baku (Baki)||Abseron|Agcabadi|Agdam|Agdas|Agstafa|Agsu|Ali Bayramli|Astara|Balakan|Barda|Beylaqan|Bilasuvar|Cabrayil|Calilabad|Daskasan|Davaci|Fuzuli|Gadabay|Ganca|Goranboy|Goycay|Haciqabul|Imisli|Ismayilli|Kalbacar|Kurdamir|Lacin|Lankaran|Lerik|Masalli|Mingacevir|Naftalan|Naxcivan|Neftcala|Oguz|Qabala|Qax|Qazax|Qobustan|Quba|Qubadli|Qusar|Saatli|Sabirabad|Saki|Saki|Salyan|Samaxi|Samkir|Samux|Siyazan|Sumqayit|Susa|Susa|Tartar|Tovuz|Ucar|Xacmaz|Xankandi|Xanlar|Xizi|Xocali|Xocavand|Yardimli|Yevlax|Yevlax|Zangilan|Zaqatala|Zardab';
...
city_states['United States'] = usa_cities_states;
...
function get_random_city(country) {
    var cities = city_states[country];
    alert(cities);
...
/*
 * Read location from array given by php
 * and fill the form
 */

function populate_location_selects(data_region, data_country, data_city_state) {

    //old
//    country.disabled = false;
//    city_state.disabled = false;
//    region.options[0] = new Option(data_region, data_region);
//    country.options[0] = new Option(data_country, data_country);
//    city_state.options[0] = new Option(data_city_state, data_city_state);

    //new

    if (countries[data_region])
    {
        country.disabled = false;
        country.options[0] = new Option('Select Country', '');
        countryArr = countries[data_region].split('|');
        for (var i = 0; i < countryArr.length; i++) {
            country.options[i + 1] = new Option(countryArr[i], countryArr[i]);
        }
        if (city_states[data_country])
        {
            city_state.disabled = false;
            city_state.options[0] = new Option('Select Nearest Division', '');
            city_stateArr = city_states[data_country].split('|');
            for (var i = 0; i < city_stateArr.length; i++)
                city_state.options[i + 1] = new Option(city_stateArr[i], city_stateArr[i]);
        } else {
            city_state.disabled = true;
        }
    } else
...
function get_all_locations() {
    ...
    var all = [];
    all = $.merge(all, all_regions);
    all = $.merge(all, all_countries);
    all = $.merge(all, all_cities);

    return all;
}

function get_region_array(region){
    return countries[region].split('|');
}

function get_all_countries(){
    
    var africa = get_region_array('Africa');
    var oceania = get_region_array('Oceania');
    var caribbean = get_region_array('Caribbean');
    var central_america = get_region_array('Central America');//countries['Central America'].split('|');
    var europe = get_region_array('Europe');
    var middle_east = get_region_array('Middle East');
    var north_america = get_region_array('North America');
    var south_america = get_region_array('South America');
    var asia = get_region_array('Asia');

    var all_countries = [];
    all_countries = $.merge(all_countries, africa);
    all_countries = $.merge(all_countries, oceania);
    all_countries = $.merge(all_countries, caribbean);
    all_countries = $.merge(all_countries, central_america);
    all_countries = $.merge(all_countries, europe);
    all_countries = $.merge(all_countries, middle_east);
    all_countries = $.merge(all_countries, north_america);
    all_countries = $.merge(all_countries, south_america);
    all_countries = $.merge(all_countries, asia);
...
function get_all_cities(){
    ...
    var all_cities = [];
    var north_america_cities = get_cities_by_region(north_america);
    var south_america_cities = get_cities_by_region(south_america);
    var middle_east_cities = get_cities_by_region(middle_east);
    var europe_cities = get_cities_by_region(europe);
    var central_america_cities = get_cities_by_region(central_america);
    var caribbean_cities = get_cities_by_region(caribbean);
    var oceania_cities = get_cities_by_region(oceania);
    var africa_cities = get_cities_by_region(africa);
    var asia_cities = get_cities_by_region(asia);

    all_cities = $.merge(all_cities, north_america_cities);
    all_cities = $.merge(all_cities, south_america_cities);
    all_cities = $.merge(all_cities, middle_east_cities);
    all_cities = $.merge(all_cities, europe_cities);
    all_cities = $.merge(all_cities, central_america_cities);
    all_cities = $.merge(all_cities, caribbean_cities);
    all_cities = $.merge(all_cities, oceania_cities);
    all_cities = $.merge(all_cities, africa_cities);
    all_cities = $.merge(all_cities, asia_cities);
...
function get_cities_by_region(region) {
    var all_cities = [];
    var i, j, n = region.length;
    for (i = 1; i <= n; i++) {
        var c = region[i];
        if (!empty(c)) {
            var c_cities = city_states[c].split('|');
            var n_cities = c_cities.length;
            for (j = 1; j <= n_cities; j++) {
                var city = c_cities[j];
                if (!empty(city)) {
                    all_cities.push(city + ' (' + c + ')');
                }
            }
        }
    }
...
function get_type_location(value){
    
    if(is_region(value)){
        return 'region';
    }else if(is_country(value)){
        return 'country';
    }else if(is_city_state(value)){
        return 'city_state';
    }
    return 'no_type';
}
...
function is_region(value){
    return check_location_in_array(value,all_regions);
}

function is_country(value){
    var all_countries = get_all_countries();
    return check_location_in_array(value,all_countries);
}

function is_city_state(value){
    var all_cities = get_all_cities();
    return check_location_in_array(value,all_cities);
}

function check_location_in_array(value, array){
    var is = $.inArray(value,array);
    if(is == -1){
        return false;
    }
    return true;
...
function get_city_from_city_and_country(value){
    var n = value.length;
    var i;
    var country_read = false;
    
    for(i = n-1; i >= 0; i--){
        if(value[i] == '(' && !country_read){
            country_read = true;
        }else if(value[i] != '' && country_read){
            var end = i;
...
function get_country_from_city_and_country(value){
    var n = value.length;
    var i;
    var start=0;
    var end=0;
...
function get_distance_from_lat_lon_in_km(lat1, lon1, lat2, lon2) {
    ...
    var dLat = deg_to_rad(lat2 - lat1);  // deg_to_rad below
...
function usa_get_distance_between_cities(c1,c2){
    var ori_lat = usa_get_latitude_by_city_state(c1);
    var ori_lon = usa_get_longitude_by_city_state(c1);
    var des_lat = usa_get_latitude_by_city_state(c2);
    var des_lon = usa_get_longitude_by_city_state(c2);
    return get_distance_from_lat_lon_in_km(ori_lat, ori_lon, des_lat, des_lon);
}

function usa_get_latitude_by_city_state(city){
    var obj = JSON.parse(usa_cities_states_coord_json);
    return obj[city].lat;
}

function usa_get_longitude_by_city_state(city){
    var obj = JSON.parse(usa_cities_states_coord_json);
    return obj[city].lon;
}
