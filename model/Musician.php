...
class Musician extends User {
    ...
    private static $table = 'musicians';
    ...
    public static function get_search_result($params) {
        //tables
        $musician_exp_alone_table = MusicianExperienceAlone::get_table_name();
        $musician_exp_bands_table = MusicianExperienceBand::get_table_name();
        //sql
        ...
        $instrument_alone_to_sql = DataStructure::instrument_to_sql_ON_from_INNER_JOIN($params, $musician_exp_alone_table, 'instrument');
        $instrument_bands_to_sql = DataStructure::instrument_to_sql_ON_from_INNER_JOIN($params, $musician_exp_bands_table, 'instrument');
        $genre_alone_to_sql = DataStructure::genre_to_sql_ON_from_INNER_JOIN($params, $musician_exp_alone_table, 'genre');
        $genre_bands_to_sql = DataStructure::genre_to_sql_ON_from_INNER_JOIN($params, $musician_exp_bands_table, 'main_genre');
        ...
        $args = [
            ...
            'inner_join_on' => [
                ...
                1 => [
                    'inner_join' => [
                        'musicians_experience_alone'
                    ],
                    'on' => [
                        'users.id = musicians_experience_alone.musician_id',
                        $instrument_alone_to_sql,
                        $genre_alone_to_sql
                    ],
                ],
                2 => [
                    'inner_join' => [
                        'musicians_experience_bands'
                    ],
                    'on' => [
                        'users.id = musicians_experience_bands.musician_id',
                        $instrument_bands_to_sql,
                        $genre_bands_to_sql
                    ],
                ]
            ],
