...
<div id="delete_experience_musician_bands_form">
    <?php
    ...
    <form action="" method="post">
        <ul>
            ...
            $mode = 'delete_experience_musician_bands';
            ?>
            <p></p>
            <li>
                <label></label>
                <span class="dialog_confirm deletion">Do you confirm the withdraw of the experience in the row </span>
                <span class="dialog_confirm deletion" id="experience_musician_bands_row_to_delete"></span>
